...
struct WordDetailsView: View {
    ...
    var body: some View {
        ...
        .padding()
        .navigationTitle(viewModel.selectedWord?.wordItself ?? "")
        .toolbar {
    ...
    private var title: some View {
        Text(viewModel.selectedWord?.wordItself ?? "")
            .font(.title)
            .bold()
    ...
    private var content: some View {
        ScrollView {
            HStack {
                ...
                Spacer()
                Button {
                    viewModel.speak(viewModel.selectedWord?.wordItself)
                } label: {
            ...
            HStack {
                if !isEditing {
                    ...
                    Picker(selection: Binding(get: {
                        viewModel.selectedWord?.partOfSpeech ?? ""
                    }, set: { newValue in
